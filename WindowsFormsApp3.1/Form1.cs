...
namespace WindowsFormsApp29
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)//при кліку два рази на Button1 викликається ця функція
        {
            ...
            int size_array = System.Convert.ToInt32(textBox1.Text);//конвертуєм розмір масиву в textBox1
